...
// renting pages.
import AddRentingDetails from "../../pages/renting_pages/AddRentingDetails";
import AllProductRentDetails from "../../pages/renting_pages/AllProductRentDetails";
import UpdateRentDetails from "../../pages/renting_pages/UpdateRentDetails";
// venue pages.
      ...
      <main className="flex-grow py-6">
        <Routes>
          ...
          <Route
            ...
            element={
              <PrivateRoute allowedRoles={["superadmin"]}>
                <PageTitle title="Add Renting Details">
                  <AddRentingDetails />
                </PageTitle>
              </PrivateRoute>
            }
          ...
          <Route
            ...
            element={
              <PrivateRoute allowedRoles={["superadmin"]}>
                <PageTitle title="All Products Rent Details">
                  <AllProductRentDetails />
                </PageTitle>
              </PrivateRoute>
            }
          />
          ...
          <Route
            path="/update-rent-details/:productId"
            element={
              <PrivateRoute allowedRoles={["superadmin"]}>
                <PageTitle title="Update Rent Details">
                  <UpdateRentDetails />
                </PageTitle>
              </PrivateRoute>
            }
