...
const EmployeeDashboard = () => {
  ...
  // Redirect only once if userId is null and token was invalid/missing
  useEffect(() => {
    if (userId === null) {
  ...
  const filteredCards = useMemo(() => {
    if (!search.trim()) return dummyCards;
