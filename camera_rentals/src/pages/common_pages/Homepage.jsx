...
//     axios.get(`${globalBackendRoute}/api/get-all-rent-details`).then((res) => {
//       const rentedCounts = {};
//       res.data.forEach((r) => {
...
//             <button className="bg-red-600 text-white px-5 py-2 rounded hover:bg-red-700 transition text-sm sm:text-base">
//               Explore Collections
//             </button>
//             <button className="border border-white text-white px-5 py-2 rounded hover:bg-white hover:text-red-600 transition text-sm sm:text-base">
//               Login / Register
//             </button>
//           </div>
//         </div>
...
//             ? "bg-gradient-to-b from-gray-200 via-white to-white text-gray-900 font-bold text-xl"
//             : "bg-white text-gray-900 font-bold text-xl"
//         }`}
//           >
//             <img
...
//           <div
//             key={product._id}
//             className="relative rounded bg-white min-h-[18rem] transition duration-300 ease-in-out text-center p-3 flex flex-col justify-between
